...
#### Orientadora: [Leonardo Forero Mendonza]([https://github.com/link_do_github](https://github.com/leofome8)).
...
- [Link para o código]([https://github.com/link_do_repositorio](https://github.com/vininovato/Compreensao-do-perfil-de-consumo-atraves-da-analises-de-clusters-aplicando-K-Means/blob/main/PoC_code.ipynb)).
